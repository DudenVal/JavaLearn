...
// public class Lection1 {
//     public static void main(String[] args) {
//         String s = null; // нужно дать значение
...
// Коментарий
// main - это public static void main(String[] args) {}
// sysout - это System.out.println("text");   
...
//     public static void main(String[] args) {
//         float e = 2.7f;     //В конце ставим f(float)
//         double pi = 3.1415;
...
//     public static void main(String[] args) {
//         var a = 123;
//         System.out.println(a); //123 int
//         var d = 123.456;
//         System.out.println(d);  // 123.456 double
//     }
// }
